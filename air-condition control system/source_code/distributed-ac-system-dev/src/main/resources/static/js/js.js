...
function roomTimerFunction(str){
    $.ajax({
        url: "http://localhost:8080/admin/roomState/" + str,
        type: "GET",
        global: "false",
        dataType: "json",
        data: {},
        success: function (data) {
            $('#roomState').show();
            $('#roomSelect').hide();
            $('#roomPowerOn').text(data['powerOn']);
            $('#roomServer').text(data['inService']);
            $('#roomCurTemperature').text(data['nowTemp']);
            $('#roomTarTemperature').text(data['tarTemp']);
            $('#roomSpeed').text(data['funSpeed']);
            $('#roomFeeRate').text(data['feeRate']);
            $('#roomTotalFee').text(data['totalFee']);
...
function refreshCustomerRoomSate(roomID){
    $.ajax({
        headers: {},
        url: "http://localhost:8080/customer/requestRoomState",
        type: "GET",
        dataType: "json",
        data: {"roomID": parseInt(roomID)},
        success: function (data) {

            $('#customerRoomPowerOn').text(data['powerOn']);
            $('#customerRoomServer').text(data['inService']);
            $('#customerRoomCurTemperature').text(data['nowTemp']);
            $('#customerRoomTarTemperature').text(data['tarTemp']);
            $('#customerRoomSpeed').text(data['funSpeed']);
            $('#customerRoomFeeRate').text(data['feeRate']);
            $('#customerRoomTotalFee').text(data['totalFee']);
...
$(function () {
    ...
    $('#saveCustomerRoomInitTemp').click(function () {
        ...
        if(roomInitTemp > 30){
            ...
            $.ajax({
                headers: {},
                url: "http://localhost:8080/customer/setInitTemp",
                type: "POST",
                dataType: "json",
...
$(function () {
    ...
    $('#customerRequestOn').click(function () {
        ...
        $.ajax({
            headers: {},
            url: "http://localhost:8080/customer/requestOn",
            type: "POST",
            dataType: "json",
    ...
    $('#customerRequestOff').click(function () {
        ...
        $.ajax({
            headers: {},
            url: "http://localhost:8080/customer/requestOff",
            type: "POST",
            dataType: "json",
            data: {"roomID": parseInt(curRoomID)},
            success: function (data) {
    ...
    $('#saveCustomerTemp').click(function () {
        ...
        $.ajax({
            headers: {},
            url: "http://localhost:8080/customer/changeTargetTemp",
            type: "POST",
            dataType: "json",
    ...
    $('#saveCustomerFSpeed').click(function () {
        ...
        $.ajax({
            headers: {},
            url: "http://localhost:8080/customer/changeFanSpeed",
            type: "POST",
            dataType: "json",
