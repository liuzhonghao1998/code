...
func (setup *FabricSetup) CreateChannelClient() error {
	...
	// ccPolicy := policydsl.SignedByAnyMember([]string{"org1.hf.chainhero.io"})
	...
	setup.channelClient, err = channel.New(clientContext)
	if err != nil {
...
func (setup *FabricSetup) CreateLedgerClient() error {
	var err error
	clientContext := setup.sdk.ChannelContext(setup.ChannelID, fabsdk.WithUser(setup.UserName))
	...
	fmt.Println("ledgerClient client created")
	return nil
}
