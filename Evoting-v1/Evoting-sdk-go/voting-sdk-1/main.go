...
import (
	...
	"Evoting-v1/Evoting-sdk-go/voting-sdk-1/web"
...
func main() {
	...
	if err != nil {
		fmt.Printf("Unable to create private channelclient: %v\n", err)
		return
	}

	err = privateSetup.CreateLedgerClient()
	if err != nil {
		fmt.Printf("Unable to create private ledgerclient: %v\n", err)
		return
	}
