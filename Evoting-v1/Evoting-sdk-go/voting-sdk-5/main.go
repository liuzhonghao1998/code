...
import (
	...
	"Evoting-v1/Evoting-sdk-go/voting-sdk-5/web"
	"Evoting-v1/Evoting-sdk-go/voting-sdk-5/web/controllers"
)
...
func main() {
	...
	privateSetup := blockchain.FabricSetup{
		...
		OrgAdmin:   "Admin",
		OrgName:    "PrivateMSP",
		ConfigFile: "/Users/liuzhonghao/go/src/Evoting-v1/Evoting-sdk-go/voting-sdk-5/config.yaml",
