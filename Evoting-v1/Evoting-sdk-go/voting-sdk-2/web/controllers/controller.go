...
func renderTemplate(w http.ResponseWriter, r *http.Request, templateName string, data interface{}) {
	lp := filepath.Join("/Users/liuzhonghao/go/src/Evoting-v1/Evoting-sdk-go/voting-sdk-2/web", "templates", "layout.html")
	tp := filepath.Join("/Users/liuzhonghao/go/src/Evoting-v1/Evoting-sdk-go/voting-sdk-2/web", "templates", templateName)
